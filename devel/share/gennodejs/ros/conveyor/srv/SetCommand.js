...
class SetCommandRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetCommandRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetCommandRequest(null);
...
class SetCommandResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetCommandResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetCommandResponse(null);
...
module.exports = {
  ...
  datatype() { return 'conveyor/SetCommand'; }
};
